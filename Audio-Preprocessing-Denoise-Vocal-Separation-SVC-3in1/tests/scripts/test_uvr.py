...
if __name__ == "__main__":
    processor = UVRExtractor(model=config.processor.uvr_path)
    processor.process_file(infile=PROJECT_ROOT+"/tests/data/530adda3-e057-4c00-846f-1d8b8ab67eb3.mp3",
                           outfile_acc=PROJECT_ROOT+"/tests/data/530adda3-e057-4c00-846f-1d8b8ab67eb3_acc_uvr.mp3",
                           outfile_vocal=PROJECT_ROOT+"/tests/data/530adda3-e057-4c00-846f-1d8b8ab67eb3_vocal_uvr.mp3")
