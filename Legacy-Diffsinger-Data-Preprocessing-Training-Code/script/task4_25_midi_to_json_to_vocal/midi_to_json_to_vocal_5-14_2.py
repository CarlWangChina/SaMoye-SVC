...
if __name__ == "__main__":
    # python script/task4_25_midi_to_json_to_vocal/midi_to_json_to_vocal_5-14_2.py
    midi_dir = root_path / "data/human_midi/all-midi-zj"
    output_dir = root_path / "data/human_midi_output/all-midi-zj"
